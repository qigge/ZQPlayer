...
// 控件
@property (nonatomic, strong) UIButton *backBtn; // 全屏后的返回按钮
@property (nonatomic, strong) UIView *bottomView; // 底部包含，播放、当前时间、总时间、进度条等视图
...
@property (nonatomic, strong) UISlider *videoSlider; // 视频播放进度条
